Cards Against Humanity's [Pulse of the Nation](https://thepulseofthenation.com/) project conducted monthly polls into people's social views, political views, and other nonsense.
This data set contains answers to the following survey questions:



- `income`:                What is your income (in $1000s per year)?
- `gender`:                What gender do you identify with (female, male, other)? NOTE: This is a rare dataset that recognizes gender is not binary, but unfortunately uses the category “other”.
